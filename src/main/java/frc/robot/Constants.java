...
public final class Constants {
    public final static class Motors {
        // Drivetrain
        public static final CANSparkMax DRIVE_FRONT_LEFT = new CANSparkMax(6, MotorType.kBrushless); // ID = 1
        ...
        public static final CANSparkMax RIGHT_ARM_ANGLE = new CANSparkMax(1, MotorType.kBrushless); // ID = 6
    ...
    public static final class Buttons {
        public static final JoystickButton J_BUTTON_ONE = new JoystickButton(Joysticks.JOYSTICK, 1);
        public static final JoystickButton J_BUTTON_TWO = new JoystickButton(Joysticks.JOYSTICK, 2);
        public static final JoystickButton J_BUTTON_THREE = new JoystickButton(Joysticks.JOYSTICK, 3);
        public static final JoystickButton J_BUTTON_FOUR = new JoystickButton(Joysticks.JOYSTICK, 4);
        public static final JoystickButton J_BUTTON_FIVE = new JoystickButton(Joysticks.JOYSTICK, 5);
        public static final JoystickButton J_BUTTON_SIX = new JoystickButton(Joysticks.JOYSTICK, 6);
